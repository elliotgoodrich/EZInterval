...
BOOST_AUTO_TEST_CASE(Constructor) {
	...
	// Must use () to construct as {} fails to compile with the boost macro
	BOOST_CHECK_THROW(ez::interval<int>(0, 0, ez::right_open), ez::empty_interval);
...
BOOST_AUTO_TEST_CASE(Intersection) {
	...
	BOOST_CHECK_THROW(intersection(ez::make_interval[0][1], ez::make_interval[3][4]),
	                  ez::empty_interval);
}
